...
export class WidgetsPage {
    ...
    async openAddModal(evenTarget) {
        const {shouldInvalidate} = await assistOS.UI.showModal("edit-widget-modal", {}, true)
        if (shouldInvalidate) {
            this.invalidate();
        }
    }
    ...
    async openEditModal(evenTarget,id) {
        const {shouldInvalidate} = await assistOS.UI.showModal("edit-widget-modal", {id}, true)
        if (shouldInvalidate) {
            this.invalidate();
        }
    }
    async previewPage(evenTarget,id) {
        const modal = await assistOS.UI.showModal("web-assistant-preview-page-modal", {
            presenter: "web-assistant-preview-page-modal",
            id
        }, true)
    }
