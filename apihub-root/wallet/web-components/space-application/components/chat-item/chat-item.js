    ...
    async beforeRender() {
        ...
        if (this.role !== "own") {
            ...
            this.chatBoxOptions = `<div class="chat-options other-message">
                ...
                <button class="copy-button chat-option-button" data-local-action="copyMessage" data-tooltip="Copy Text"> 
                ...
                <button class="chat-option-button" data-local-action="addToLocalContext" data-tooltip="Add to Agent's Context">
...
\t\ts-2.1,0.4-2.8,1.2c-0.8,0.8-1.2,1.7-1.2,2.8c0,1,0.4,2.1,1.2,2.8C164.5,34.5,165.6,34.9,166.6,34.9z"/>
            ...
            this.chatBoxOptions = `<div class="chat-options myself-message">
                ...
                <button class="chat-option-button" data-local-action="addToLocalContext" data-tooltip="Add to Agent's Context"><svg height="22px" width="22px" version="1.2" baseProfile="tiny" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
\t  viewBox="0 0 256 256" xml:space="preserve">
<g id="XMLID_40_">
\t<path id="XMLID_12_" fill="white" d="M66.2,129.3c-4.1,0-7.5,3.4-7.5,7.5c0,4.2,3.4,7.6,7.5,7.6c4.2,0,7.6-3.4,7.6-7.6
\t\tC73.8,132.7,70.4,129.3,66.2,129.3z"/>
...
\t\ts-2.1,0.4-2.8,1.2c-0.8,0.8-1.2,1.7-1.2,2.8c0,1,0.4,2.1,1.2,2.8C164.5,34.5,165.6,34.9,166.6,34.9z"/>
                ...
                <button class="chat-option-button" data-local-action="addToGlobalContext" data-tooltip="Memorize"><svg width="26px" height="26px" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
