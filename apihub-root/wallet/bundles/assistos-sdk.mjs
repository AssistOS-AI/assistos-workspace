...
(function(module) {
  const ServerSideSecurityContext3 = ServerSideSecurityContext_1;
  const ClientSideSecurityContext3 = ClientSideSecurityContext_1;
  const constants2 = constants$2;
  ...
  function sdkModule(moduleName, securityContext) {
    let module2 = _loadModule(moduleName);
    this.__securityContext = securityContext;
    for (let key in module2) {
      if (typeof module2[key] === "function" && !(module2[key].prototype && Object.getOwnPropertyNames(module2[key].prototype).length > 1 && module2[key].prototype.constructor === module2[key])) {
        this[key] = module2[key].bind(this);
      } else {
        this[key] = module2[key];
      }
    }
    return this;
  }
  ...
  module.exports = {
    ...
    envType: envType2,
    ServerSideSecurityContext: ServerSideSecurityContext3,
    ClientSideSecurityContext: ClientSideSecurityContext3,
    utils: utils2
  };
})(assistosSdk);
...
const ServerSideSecurityContext2 = assistosSdkExports.ServerSideSecurityContext;
const ClientSideSecurityContext2 = assistosSdkExports.ClientSideSecurityContext;
const utils = assistosSdkExports.utils;
export {
  ClientSideSecurityContext2 as ClientSideSecurityContext,
  ServerSideSecurityContext2 as ServerSideSecurityContext,
  constants,
  assistosSdkExports as default,
  envType,
  loadModule,
  utils
};
