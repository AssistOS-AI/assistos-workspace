(function(global, factory) {
  ...
  function requireDocument$1() {
    ...
    const envType2 = requireAssistosSdk().envType;
    const constants2 = constants$2;
  ...
  function requireSpace() {
    ...
    async function addCollaborators(referrerEmail, spaceId, collaborators, spaceName) {
      ...
      let userModule = requireAssistosSdk().loadModule("user", this.__securityContext);
      const validEmails = [];
  ...
  function requireUser() {
    ...
    async function getUserProfileImage(email) {
      ...
      let userInfo = await this.sendRequest(`/auth/getInfo?email=${email}`, "GET");
      let spaceModule = requireAssistosSdk().loadModule("space", this.__securityContext);
  ...
  var hasRequiredAssistosSdk;
  function requireAssistosSdk() {
    if (hasRequiredAssistosSdk) return assistosSdk.exports;
    hasRequiredAssistosSdk = 1;
    (function(module2) {
    ...
    return assistosSdk.exports;
  }
  var assistosSdkExports = requireAssistosSdk();
  const sdk = /* @__PURE__ */ getDefaultExportFromCjs$1(assistosSdkExports);
  const loadModule = sdk.loadModule;
  const constants = sdk.constants;
  const envType = sdk.envType;
  const ServerSideSecurityContext = sdk.ServerSideSecurityContext;
  const ClientSideSecurityContext = sdk.ClientSideSecurityContext;
