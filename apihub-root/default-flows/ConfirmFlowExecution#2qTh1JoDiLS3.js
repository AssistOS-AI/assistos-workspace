export class ConfirmFlowExecution {
    ...
    async start(flowId, parameters, result) {
        try {
            ...
            let context = `You are a custom GPT agent designed for specific tasks in a software application. You have successfully executed the operation that has this description: ${flow.class.description} which had these necessary parameters: ${JSON.stringify(flow.class.parameters)}. You have executed the operation using these parameters: ${JSON.stringify(parameters)}. `;
