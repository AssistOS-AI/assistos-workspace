export class AddPersonality {
    ...
    constructor() {
        ...
        this.description = "Adds a new personality";
        this.agentConfigs = {
            description: "Adds a new personality. A name and a thorough description of the personality must be provided. The description should contain key human features. Optionally, a photo can be added. This photo will be encoded in base 58",
            parameters: [
